...
contract CErc20 is CToken, CErc20Interface {
     ...
     */
    function mint(uint mintAmount, bool enterMarket) external override returns (uint) {
    ...
    /**
     * Modified from transmissions11 (https://github.com/transmissions11/libcompound/blob/main/src/LibCompound.sol)
